...
type PropertySyntax = LooseAutocomplete<_PropertySyntax>;
...
declare function createGlobalTheme<ThemeTokens extends Tokens>(selector: string, tokens: WithOptionalLayer<ThemeTokens>): Resolve<WithoutLayer<ThemeVars<ThemeTokens>>>;
declare function createGlobalTheme<ThemeContract extends Contract>(selector: string, themeContract: ThemeContract, tokens: WithOptionalLayer<MapLeafNodes<ThemeContract, string>>): void;
